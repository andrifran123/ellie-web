        ...
        <main id="main" className="relative z-10 px-6 md:px-10 py-10">
          ...
          <section className="max-w-6xl mx-auto mt-20 md:mt-28 grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="mt-4 text-purple-300 italic text-lg">
                Authentic photos. Limitless conversation. Unconditional connection.
              </p>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                {
                  title: "Ultra-realistic generated images",
                  text: "Engineered for hyper-realism. Dynamic lighting and cinematic composition for next-gen visual immersion.",
                  icon: "📸",
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-purple-200 leading-relaxed max-w-3xl">
                  Conversations are private to you. Ellie is designed for mature audiences (18+)
                  and supports unrestricted, open-ended roleplay.
          ...
          >
            ...
            <div className="text-purple-400 text-xs">
              <div>Contact: support@ellie-elite.com</div>
            </div>

            {/* AI Disclaimer */}
            <div className="text-purple-500/70 text-xs max-w-2xl mx-auto leading-relaxed">
              Ellie is an Artificial Intelligence chatbot. All characters, visuals, and scenarios are entirely fictional and generated by computer software. No actual human beings are depicted. All characters appearing in this content are fictitious and 18 years of age or older. This service is for entertainment purposes only.
            </div>
